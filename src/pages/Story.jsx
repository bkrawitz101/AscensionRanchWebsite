    ...
    <div className="min-h-screen bg-[#FDFCF8] font-serif text-[#2D2926]">
      ...
      <main className="story-scroll">
        ...
        <section className="story-section">
          ...
          <div className="content px-6">
            <div className="panel text-left">
              <p className="lead">Ascension Ranch was born from a calling.</p>
            </div>
          </div>
        </section>
        ...
        <section className="story-section">
          ...
          <div className="content px-6">
            <div className="panel text-left">
              <blockquote className="my-4 border-l-4 border-[#A67C52] pl-4 italic text-[#2D2926]">“A place to remember how to belong to the land.”</blockquote>
              <p>
